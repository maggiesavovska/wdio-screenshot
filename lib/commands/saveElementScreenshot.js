...
exports.default = function async(fileName, elementSelector, driver, options) {
  var base64Image;
  return _regenerator2.default.async(function async$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        ...
        case 3:
          _context.next = 5;
          console.log('before make screenshot');
          return _regenerator2.default.awrap((0, _makeElementScreenshot2.default)(driver, elementSelector, options));
